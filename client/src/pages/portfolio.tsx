      ...
      <div className="min-h-screen bg-gray-50 pb-24">
        ...
        <div className="px-6 mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {ASSETS.map((asset) => (
              <Link key={asset.symbol} href={`/portfolio/${asset.symbol}`}>
                <Card className="p-4 border-gray-100 shadow-sm hover:shadow-md transition-all cursor-pointer active:scale-[0.98]">
